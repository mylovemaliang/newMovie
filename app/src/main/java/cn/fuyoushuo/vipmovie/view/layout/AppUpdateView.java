...
import cn.fuyoushuo.commonlib.utils.VolleyRqFactory;
...
public class AppUpdateView extends BaseActivity {
    ...
    public static final String DOWN_LOAD_FILE_PATH = "";
    ...
    public void getUpdateInfo(boolean autoCheck) {
        ...
        // TODO: 2017/3/30 fix http path http://180.76.146.164:8085/mobile/update.htm?t=10&c=official
        RequestQueue volleyRq = VolleyRqFactory.getInstance().getQequestQueue(MyApplication.getContext());
        String url = "http://180.76.146.164:8085/mobile/update.htm?t=10&c="+channel;
    ...
    private Handler handler1 = new Handler() {
        public void handleMessage(Message msg) {//这里的场景，是在异步子线程获取到远程的app最新版本信息后，send一个Message过来处理
            ...
            if (isNeedUpdate()) {
                //安装路径
                mStoreApkPath = new File(
                    MyApplication.getContext().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS),
                    "fqbnewest.apk");
                if (mStoreApkPath.exists()) {
                    //安装
                ...
                Toast.makeText(currentActivity, "当前已经是最新版本",   Toast.LENGTH_SHORT).show();
            }
    ...
    private boolean isNeedUpdate() {
        return info.getVersion() > getCurrentAppVersion() ? true : false;
    }
    ...
    public void downFile() {
        ...
        com.squareup.okhttp.Request request = new com.squareup.okhttp.Request.Builder().url(info.getUrl()).build();
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(com.squareup.okhttp.Response response) throws IOException {
                ...
                try {
                    ...
                    if (is != null) {
                        fileOutputStream = new FileOutputStream(mStoreApkPath);
    ...
    //是否是wifi环境，WiFi环境返回true,否则返回false
